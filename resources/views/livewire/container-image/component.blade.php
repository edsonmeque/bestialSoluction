<div class="tab-pane fade " id="permissions_content" role="tabpanel">
    <div class="row mt-5">
                        ...
                        <table id="zero-config" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{\App\Models\User::permission($permission->name)->count()}}</td>
                                     <td>
                                     ...
                                     <td class="text-center">
                                         <div class="n-check" id="divPermission">
                                             <label class="new-control new-checkbox checkbox-primary">
                                                 <input data-name="{{$permission->name}}"
                                                 {{$permission->checked==1? 'checked': 'unchecked'}}
