...
<body class="alt-menu sidebar-noneoverflow">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                ...
                                <h6><span>Oi,</span>{{auth()->user()->name}}</h6>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="dropdown-item">
                                ...
                                onclick="event.preventDefault();
                                              document.getElementById('logout-form').submit();"><span class="mb-0 d-inline-block me-1"><i class="ti ti-logout"></i></span>
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu active">
                        <a href="{{asset('dashboard')}}" aria-expanded="true">
                            <div class="">
                    ...
                    <li class="menu single-menu">
                        <a href="#app" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span>Dados Nacional</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                        </a>
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                            <li>
                                <a href="{{asset('/provinces')}}"> Províncias</a>
                            </li>
                            <li>
                    ...
                    <li class="menu single-menu">
                        <a href="#components" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span>Dados de Contentores</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                        </a>
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#topAccordion">
                            <li>
                                <a href="{{asset('/containers')}}">Cadastar de Container </a>
                            </li>

                            <li>
                                <a href="{{asset('/containers_images')}}">Contentores & Imagems </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        <a href="#uiKit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span>Visulizacao de Dados</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                        </a>
                        <ul class="collapse submenu list-unstyled" id="uiKit" data-parent="#topAccordion">
                            <li>
                                <a href="{{asset('/maps')}}"> Googles Maps</a>
                            </li>
                        </ul>
                    </li>
                     ...
                     <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="tables"  data-parent="#topAccordion">
                            <li>
                                <a href="{{asset('/point')}}"> Pontos sem Contentor </a>
                            </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="tables"  data-parent="#topAccordion">
                            <li>
                                <a href="{{asset('collect')}}"> Relatorio das Coletas</a>
                            </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="more" data-parent="#topAccordion">
                            ...
                            <li>
                                <a href="{{asset('roles-permission')}}">Role & Permission</a>
                            </li>
    ...
    @vite([
                ...
                // 'resources/bootstrap/js/toastr.min.js',
